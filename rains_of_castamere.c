...
const int rains[][3] = {
	...
	{ As, 2, 4}, // that's all the truth i know
	{ An, 2, 4},
	{ Gn, 2, 4},
	{ Fn, 2, 4},
	{ Dn, 2, 8},
	...
	{ As, 2, 4}, // as long and sharp as yours
	{ An, 2, 4},
	{ Gn, 2, 4},
	{ Fn, 2, 4},
	{ Dn, 2, 10},
	...
	{ En, 2, 2}, // and so he spoke
	{ Fn, 2, 2},
	{ Dn, 2, 6},
	{ Zz, 2, 2},

	{ Fn, 2, 4}, // and so he spoke
	{ Fn, 2, 2},
	{ En, 2, 2},
	{ Cn, 1, 6},
	{ Zz, 1, 2},
	...
	{ En, 2, 2}, // but now the rains
	{ Fn, 2, 2},
	{ Dn, 2, 6},
	{ Zz, 2, 2},

	{ An, 2, 4}, // weep over his hall
	{ An, 2, 4},
	{ Gn, 2, 4},
	{ En, 2, 4},
	{ Zz, 2, 2},

	{ An, 1, 2}, // and no one there to hear
	{ Fn, 2, 4},
	{ Zz, 1, 2},
	{ An, 1, 2},
	{ En, 2, 4},
